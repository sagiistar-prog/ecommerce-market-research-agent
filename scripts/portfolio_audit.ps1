...
$businessRiskTerms = @(
    ...
    (Join-Term @("New", " ", "Fada")),
    (Join-Term @("R", "X")),
    (Join-Term @((Join-Term @("R", "X")), " ", "Consult")),
    ...
    (From-Codepoints @(27431,27954,24066,22330,36164,35759)),
    ...
    (From-Codepoints @(20013,22269,20154,22312,24847,22823,21033,24314,21378)),
